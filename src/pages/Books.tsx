    ...
    <div className="max-w-4xl mx-auto page-enter">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 stagger-children">
        {books.map((book) => (
          <div
            key={book.id}
            className="group relative border border-gray-800 bg-hilbert/50 p-6 hover:border-primary transition-all duration-300 flex flex-col justify-between min-h-[200px] card-hover"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-4">
                ...
                <span className="text-xs font-mono text-gray-600 bg-gray-900 px-2 py-1">
                  {book.year}
                </span>
              </div>
            ...
            <div className="relative z-10 mt-auto pt-4 border-t border-gray-800/50">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-mono text-gray-400 hover:text-primary transition-all duration-300 group/link"
              >
