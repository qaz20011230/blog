...
const books = [
  ...
  { id: 3, title: { zh: 'Artificial：技艺、智能与第二自然', en: 'Artificial: Craft, Intelligence, and Second Nature' }, author: { zh: '良之', en: 'Ang Li' }, description: { zh: '从词源、古典哲学与中国工器传统出发，贯穿海德格尔、马克思、图灵、香农，重新夺回"人工"一词的尊严，提出专深人工智能（ASI）的完整定义与工程原则。', en: 'Reclaiming the dignity of "artificial" — from etymology and classical philosophy through Heidegger, Marx, Turing, and Shannon, this treatise proposes a principled path toward Artificial Special Intelligence distinct from AGI.' }, year: '2026', pdfUrl: '/books/Artificial.pdf' },
];
