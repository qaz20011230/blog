...
date: "2026-03-16"
category: "Logic"
description: "Turn-Lang是一种能够容纳所有基础的元架构。它不再追求“绝对真理”，而是追求“真理的可迁移性”。这是莱布尼茨梦想的当代形态。"
---
...
2025年底，Turn-Lang的第一个demo发布。

但这只是一个开始。截至目前，尚未发布稳定版本。高性能函子编译、高维重写系统的自动证明、置信度传播演算……这些方向还在等待探索。Turn-Lang不是终点，而是起点——一个让未来形式化研究可以站在其上的起点。
